...
const MATHEW_BASE = useRemote
  ? pickBaseUrl(['MATHEW_API_URL_REMOTE', 'MATHEW_API_URL', 'MATHEUS_API_URL'], 'http://100.105.232.94:1234/v1')
  : pickBaseUrl(['MATHEW_API_URL', 'MATHEW_API_URL_REMOTE', 'MATHEUS_API_URL'], 'http://100.105.232.94:1234/v1')
const MATHEW_MODEL = process.env.MATHEW_MODEL ?? 'qwen/qwen3-4b-2507'
const MATHEW_KEY = useRemote
  ? pickApiKey(['MATHEW_REMOTE_API_KEY', 'MATHEW_API_KEY', 'MATHEUS_API_KEY', 'LM_STUDIO_API_KEY'], 'lm-studio')
  : pickApiKey(['MATHEW_API_KEY', 'MATHEUS_API_KEY', 'MATHEW_REMOTE_API_KEY', 'LM_STUDIO_API_KEY'], 'lm-studio')

// ── Vision model (can analyse pictures) ───────────────────────────────
const VISION_BASE = useRemote
  ? pickBaseUrl(['QWEN_API_URL_REMOTE', 'QWEN_API_URL', 'VISION_API_URL_REMOTE'], 'http://100.114.219.75:1234/v1')
  : pickBaseUrl(['QWEN_API_URL', 'QWEN_API_URL_REMOTE', 'VISION_API_URL_REMOTE'], 'http://100.114.219.75:1234/v1')
const VISION_MODEL = process.env.QWEN_MODEL ?? 'qwen/qwen3-4b-2507'
const VISION_KEY = useRemote
  ? pickApiKey(['QWEN_REMOTE_API_KEY', 'QWEN_API_KEY', 'VISION_API_KEY', 'LM_STUDIO_VISION_API_KEY'], 'lm-studio')
  : pickApiKey(['QWEN_API_KEY', 'VISION_API_KEY', 'QWEN_REMOTE_API_KEY', 'LM_STUDIO_VISION_API_KEY'], 'lm-studio')

console.log('[ai] useRemote=%s  mathew=%s  vision=%s', useRemote, MATHEW_BASE, VISION_BASE)
